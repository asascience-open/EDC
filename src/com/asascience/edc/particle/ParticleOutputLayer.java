...
public class ParticleOutputLayer extends OutputLayerBase implements MapMouseListener {
	...
	private JFreeChart buildHistogramChart() {
		...
		JFreeChart chart = ChartFactory.createBarChart("Histogram", "Bin", partHistogramDataset.getRowKeys().get(0)
			.toString(), partHistogramDataset, PlotOrientation.VERTICAL, false, true, false);
