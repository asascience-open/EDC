...
public class NcProperties {
	...
	public void writeFile() {
		try {
			...
			root.getChild("nc_info").setAttribute("filepath", ncPath).setAttribute("type", type.toString())
				.setAttribute("starttime", startTime).setAttribute("timeinterval", timeInterval).setAttribute(
			...
			root.getChild("dimensions").setAttribute("band_dim", bandDim).setAttribute("trim_dim", trimByDim)
				.setAttribute("trim_val", trimByValue).addContent(new Element("time").setText(time)).addContent(
