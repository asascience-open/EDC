...
public class HistoryComboBox extends JComboBox {
   ...
   */
  public HistoryComboBox(PersistenceManager prefs) {
    this(prefs, 20);
  }
   ...
   */
  public HistoryComboBox(PersistenceManager prefs, int nkeep) {
    super();
    this.prefs = prefs;
    this.nkeep = nkeep;
    setEditable(true);
    ...
    if (prefs != null) {
      ArrayList list = (ArrayList) prefs.getList(getList(), null);
      setItemList(list);
    }
  }
  ...
  public void addContextMenu() {
    ...
    editComp.addMouseListener(new PopupTriggerListener() {
      ...
      public void showPopup(java.awt.event.MouseEvent e) {
        popupMenu.show(HistoryComboBox.this, e.getX(), e.getY());
      }
    });
