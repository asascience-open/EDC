...
package com.asascience.edc.ui.da;
...
public class DAComboBox extends JComboBox {
	private static final String LIST = "DAComboBoxList";
	 ...
	 */
	public DAComboBox(PersistenceManager prefs) {
		this(prefs, 20);
	}
	 ...
	 */
	public DAComboBox(PersistenceManager prefs, int nkeep) {
		super();
		this.prefs = prefs;
		this.nkeep = nkeep;
		setEditable(true);
	...
	public void addContextMenu() {
		...
		editComp.addMouseListener(new PopupTriggerListener() {
			public void showPopup(java.awt.event.MouseEvent e) {
				popupMenu.show(DAComboBox.this, e.getX(), e.getY());
			}
		});
