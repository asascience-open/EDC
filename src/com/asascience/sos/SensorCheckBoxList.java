...
public class SensorCheckBoxList extends JPanel implements ActionListener {
  ...
  public void makeCBList(List<String> items, List<String> descrips, List<Boolean> checks, List<SensorPoint> sensors, boolean trimName) {
    String s = "";
    String d = "";
    boolean c = false;
    SensorPoint p;
  ...
  public void addCheckBox(String name, String descr, boolean checked, SensorPoint sensor, boolean trimName) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (cb.sensor != null) {
      pcs.firePropertyChange("sensorClicked", null, (SensorPoint) cb.sensor);
    }
  }
