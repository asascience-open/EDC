...
public class IndeterminateProgressMonitor extends Object implements Accessible {
	 ...
	 * @see JOptionPane
	 */
	public IndeterminateProgressMonitor(Component parentComponent, Object message, String note, boolean modal,
		boolean resizable, ImageIcon monitorIcon) {
		this(parentComponent, message, note, null, modal, resizable, monitorIcon);
	}

	private IndeterminateProgressMonitor(Component parentComponent, Object message, String note,
		IndeterminateProgressMonitor group, boolean modal, boolean resizable, ImageIcon monitorIcon) {
	...
	public boolean isCanceled() {
		...
		return ((val != null) && (cancelOption.length == 1) && (val.equals(cancelOption[0])));
	}
