...
public class SplashWindow extends Window {
	...
	private SplashWindow(Frame parent, Image image) {
		super(parent);
		this.image = image;
		this.setBackground(new Color(0, 0, 0, 0));// make the window transparent
	...
	public void paint(Graphics g) {
		...
		Rectangle2D r = fm.getStringBounds(sVersion, g);
		g.drawString(sVersion, ((getWidth() / 2) - ((int) r.getWidth() / 2)), (getHeight() / 2) + 28);
	 ...
	 */
	public static void splash(URL imageURL, String version) {
		if (imageURL != null) {
			splash(Toolkit.getDefaultToolkit().createImage(imageURL), version);
		}
	}
