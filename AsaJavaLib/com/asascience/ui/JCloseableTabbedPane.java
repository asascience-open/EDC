 ...
 *
 * Created on Feb 11, 2009 @ 1:15:58 PM
 */
 ...
 * closes the tab.
 */
public class JCloseableTabbedPane extends JTabbedPane implements MouseListener, MouseMotionListener {
	...
	/**
	 * Creates a new instance of <code>JCloseableTabbedPane</code>
	 */
	 ...
	 */
	public JCloseableTabbedPane(int horizontalTextPosition) {
		super();
		init(horizontalTextPosition);
	}

	/**
	 * Initializes the <code>JCloseableTabbedPane</code>
	 * 
	 * @param horizontalTextPosition
	 *            the horizontal position of the text (e.g.
	 *            SwingUtilities.TRAILING or SwingUtilities.LEFT)
	...
	private void init(int horizontalTextPosition) {
		...
		/** Commented out to allow the "system" look & feel to come through. */
		// if (getUI() instanceof MetalTabbedPaneUI)
		// setUI(new CloseableMetalTabbedPaneUI(horizontalTextPosition));
		// else
		// setUI(new JCloseableTabbedPaneUI(horizontalTextPosition));
	}
	 ...
	 */
	public void addTabClose(String title, Component component) {
						...
						if (fireCloseTab(selIndex)) {
							if (selIndex > 0) {
								...
								MouseEvent event = new MouseEvent((Component) e.getSource(), e.getID() + 1, System
									.currentTimeMillis(), e.getModifiers(), rec.x, rec.y, e.getClickCount(), e
	...
	/**
	 * Adds an <code>JCloseableTabbedPaneListener</code> to the tabbedpane.
	 * 
	 * @param l
	 *            the <code>JCloseableTabbedPaneListener</code> to be added
	 */
	public void addJCloseableTabbedPaneListener(JCloseableTabbedPaneListener l) {
		listenerList.add(JCloseableTabbedPaneListener.class, l);
	}

	/**
	 * Removes an <code>JCloseableTabbedPaneListener</code> from the tabbedpane.
	 * 
	 * @param l
	 *            the listener to be removed
	 */
	public void removeJCloseableTabbedPaneListener(JCloseableTabbedPaneListener l) {
		listenerList.remove(JCloseableTabbedPaneListener.class, l);
	}
	 ...
	 */
	public JCloseableTabbedPaneListener[] getJCloseableTabbedPaneListener() {
		return listenerList.getListeners(JCloseableTabbedPaneListener.class);
	}
	...
	protected boolean fireCloseTab(int tabIndexToClose) {
		...
		for (Object i : listeners) {
			if (i instanceof JCloseableTabbedPaneListener) {
				if (!((JCloseableTabbedPaneListener) i).closeTab(tabIndexToClose)) {
					closeit = false;
					break;
				}
			}
		...
		public void paintIcon(Component c, Graphics g, int x, int y) {
			...
			if (doPaintCloseIcon) {
				...
				if (normalCloseIcon != null && !mouseover) {
					...
					/** Draw the fill 'X' using a polygon. */
					if (mouseover) {
						g.setColor(new Color(252, 80, 80));
					} else {
						g.setColor(Color.WHITE);
					}
					Polygon fillPoly = new Polygon();
					fillPoly.addPoint(x + 3, y_p + 3);// ul-term
					fillPoly.addPoint(x + 5, y_p + 3);// ul-right
					fillPoly.addPoint(x + 7, y_p + 5);// top-'v'1
					fillPoly.addPoint(x + 8, y_p + 5);// top-'v'2
					fillPoly.addPoint(x + 10, y_p + 3);// ur-left
					fillPoly.addPoint(x + 12, y_p + 3);// ur-term
					fillPoly.addPoint(x + 12, y_p + 5);// ur-right
					fillPoly.addPoint(x + 10, y_p + 7);// right-'v'1
					fillPoly.addPoint(x + 10, y_p + 8);// right-'v'2
					fillPoly.addPoint(x + 12, y_p + 10);// br-right
					fillPoly.addPoint(x + 12, y_p + 12);// br-term
					fillPoly.addPoint(x + 10, y_p + 12);// br-left
					fillPoly.addPoint(x + 8, y_p + 10);// bot-'v'1
					fillPoly.addPoint(x + 7, y_p + 10);// bot-'v'2
					fillPoly.addPoint(x + 5, y_p + 12);// ll-right
					fillPoly.addPoint(x + 3, y_p + 12);// ll-term
					fillPoly.addPoint(x + 3, y_p + 10);// ll-left
					fillPoly.addPoint(x + 5, y_p + 8);// left-'v'1
					fillPoly.addPoint(x + 5, y_p + 7);// left-'v'2
					fillPoly.addPoint(x + 3, y_p + 5);// ul-left

					g.fillPolygon(fillPoly);

					/** Draw the outline 'X' using a polygon. */
					g.setColor(Color.BLACK);
					Polygon outlinePoly = new Polygon();
					outlinePoly.addPoint(x + 3, y_p + 3);// ul-term
					outlinePoly.addPoint(x + 5, y_p + 3);// ul-right
					outlinePoly.addPoint(x + 7, y_p + 5);// top-'v'1
					outlinePoly.addPoint(x + 8, y_p + 5);// top-'v'2
					outlinePoly.addPoint(x + 10, y_p + 3);// ur-left
					outlinePoly.addPoint(x + 12, y_p + 3);// ur-term
					outlinePoly.addPoint(x + 12, y_p + 5);// ur-right
					outlinePoly.addPoint(x + 10, y_p + 7);// right-'v'1
					outlinePoly.addPoint(x + 10, y_p + 8);// right-'v'2
					outlinePoly.addPoint(x + 12, y_p + 10);// br-right
					outlinePoly.addPoint(x + 12, y_p + 12);// br-term
					outlinePoly.addPoint(x + 10, y_p + 12);// br-left
					outlinePoly.addPoint(x + 8, y_p + 10);// bot-'v'1
					outlinePoly.addPoint(x + 7, y_p + 10);// bot-'v'2
					outlinePoly.addPoint(x + 5, y_p + 12);// ll-right
					outlinePoly.addPoint(x + 3, y_p + 12);// ll-term
					outlinePoly.addPoint(x + 3, y_p + 10);// ll-left
					outlinePoly.addPoint(x + 5, y_p + 8);// left-'v'1
					outlinePoly.addPoint(x + 5, y_p + 7);// left-'v'2
					outlinePoly.addPoint(x + 3, y_p + 5);// ul-left

					g.drawPolygon(outlinePoly);
					...
					/** Draw the outline of the 'X'. */
					// g.drawLine(x + 3, y_p + 3, x + 10, y_p + 10);//ul-br,mid

					/** Draw the center of the 'X'. */
					// g.drawLine(x + 3, y_p + 3, x + 10, y_p + 10);//ul-br,mid
					// g.drawLine(x + 3, y_p + 4, x + 9, y_p + 10);//ul-br,bot
					// g.drawLine(x + 4, y_p + 3, x + 10, y_p + 9);//ul-br,top
					// g.drawLine(x + 10, y_p + 3, x + 3, y_p + 10);//ll-ur,mid
					// g.drawLine(x + 10, y_p + 4, x + 4, y_p + 10);//ll-ur,bot
					// g.drawLine(x + 9, y_p + 3, x + 3, y_p + 9);//ll-ur,top
					// g.setColor(col);
					if (fileIcon != null) {
	 ...
	 */
	class JCloseableTabbedPaneUI extends BasicTabbedPaneUI {
		...
		/**
		 * Creates a new instance of <code>JCloseableTabbedPaneUI</code>
		 */
		 ...
		 *            SwingUtilities.TRAILING or SwingUtilities.LEFT)
		 */
		public JCloseableTabbedPaneUI(int horizontalTextPosition) {
