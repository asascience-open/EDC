 ...
 *
 * Created on December 4, 2007, 3:36 PM
 *
...
/**
 * LERandomAccessFile.java copyright (c) 1998-2007 Roedy Green, Canadian Mind
 * Products
 * 
...
public final class LERandomAccessFile implements DataInput, DataOutput {
   ...
   *            file to read/write.
   * @param rw
   *            like {@link java.io.RandomAccessFile} where "r" for read "rw"
   ...
   * @param off
   *            offset into the array to place the bytes, <b>not</b> offset in
   *            file.
   * @param len
  ...
  public final long readLong() throws IOException {
    ...
    return (long) (work[7]) << 56
            | /* long cast necessary or shift done modulo 32 */ (long) (work[6] & 0xff) << 48 | (long) (work[5] & 0xff) << 40 | (long) (work[4] & 0xff) << 32
